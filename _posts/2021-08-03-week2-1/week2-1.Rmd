...
probability $p_{k}$, then its mean is defined as $\matbf{E}\left[y\right] =
...
\int_{\mathbf{R}} y p\left(y) dy$. Think of integral in the continuous case like
...
4. The variance of a random variable Y is defined as $\mathbf{V}\left[y\right] =
