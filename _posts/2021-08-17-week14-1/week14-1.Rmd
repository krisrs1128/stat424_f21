...
description: |
  Effects that are unique to a subset of configurations.
author:
  - name: Kris Sankaran
    url: {}
date: 12-14-2021
...
_Readings [14.1](https://www.wiley.com/en-us/Design+and+Analysis+of+Experiments%2C+10th+Edition-p-9781119492443#content-section), [Rmarkdown]()_
...
include_graphics("https://uwmadison.box.com/shared/static/kbs80435ds41u0qp7typvmuiaibyjlpm.png")
```
...
include_graphics("https://uwmadison.box.com/shared/static/g6yb4uu8nncnqc39rbjhh3kz8bv9jzwc.png")
```
...
include_graphics("https://uwmadison.box.com/shared/static/fy3jwyeou1bu6nyo1i2lypg8juj80z8k.png")
```
...
include_graphics("https://uwmadison.box.com/shared/static/6bona7dg8dl6fbnfvetovq2cl9l5zo11.png")
```
...
purity <- read_csv("https://uwmadison.box.com/shared/static/uub0t6lvii52rxyygb2yt4ph3vmionjz.csv") %>%
  mutate_at(vars(-purity), as.factor)
```
...
include_graphics("https://uwmadison.box.com/shared/static/twey7ufa1zeaq8lgjpdg1uu66a7fi2l4.png")
```

```{r}
lmer(purity ~ supplier + (1 | supplier:batch), data = purity)
```
...
#fit <- lmer(purity ~ (1 | supplier) + (1 | supplier:batch), purity) # equivalent longhand
summary(fit)
```

An detail to keep in mind is that, for nested designs, computation of
