...
can get many replicates, our estimates of hte mean will improve (orange -> red)
...
individuals become detectable. In this example, blocking helped remove nuiscance
