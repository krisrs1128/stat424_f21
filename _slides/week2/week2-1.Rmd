...
$$\text{Option 1:   } \sqrt{\frac{1}{n - 1}\sum_{i = 1}^{n}\left(x_i - \bar{x}\right)^2} \\ \text{Option 2:   } 1.483\left[\frac{1}{n}\sum_{i = 1}^{n} \left|x_i - \bar{x}_i\right|\right]$$
...
This theorem reduces calculations across arbitrary distributions into
