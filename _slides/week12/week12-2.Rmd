...
* Explain the choices made in your sketch  
...
(3) Inspect the contour plots associated with each response. Does the best
configuration for leakage satisfy the tear constraint? If not, find a good
(though for simplicity, not necessarily optimal) point that does.
